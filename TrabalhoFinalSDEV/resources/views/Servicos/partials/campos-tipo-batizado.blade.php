<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        <label for="detalhes_fotos_batizado" class="block font-semibold mb-1 text-white">Fotos</label>
    ...
    <div>
        <label for="detalhes_video_batizado" class="block font-semibold mb-1 text-white">Vídeo</label>
    ...
    <div>
        <label for="detalhes_drone_batizado" class="block font-semibold mb-1 text-white">Drone</label>
    ...
    <div>
        <label for="detalhes_sde_batizado" class="block font-semibold mb-1 text-white">SDE</label>

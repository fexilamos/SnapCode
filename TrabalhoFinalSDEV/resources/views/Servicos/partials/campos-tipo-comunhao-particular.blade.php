...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div class="md:col-span-2">
        ...
        <textarea name="detalhes[info_extra_crianca]" class="form-textarea w-full rounded border-gray-300 text-black"></textarea>
    </div>
</div>
<br>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <textarea name="detalhes[instrucoes_igreja]" class="form-input w-full rounded border-gray-300 text-black"></textarea>
    </div>
    <div>

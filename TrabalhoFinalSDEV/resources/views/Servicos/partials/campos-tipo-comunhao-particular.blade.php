<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        <label for="detalhes_fotos_comunhao_particular" class="block font-semibold mb-1 text-white">Fotos</label>
    ...
    <div>
        <label for="detalhes_video_comunhao_particular" class="block font-semibold mb-1 text-white">Vídeo</label>
    ...
    <div>
        <label for="detalhes_drone_comunhao_particular" class="block font-semibold mb-1 text-white">Drone</label>
    ...
    <div>
        <label for="detalhes_sde_comunhao_particular" class="block font-semibold mb-1 text-white">SDE</label>
    ...
    <div>
        <label class="block font-semibold mb-1 text-white">Fotos Convidados</label>
    ...
    <div>
        <label class="block font-semibold mb-1 text-white">Nº Convidados</label>
    ...
    <div>
        <label class="block font-semibold mb-1 text-white">Venda Fotos</label>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
        <label class="block font-semibold mb-1 text-white">Hora Chegada</label>
    ...
    <div>
        <label class="block font-semibold mb-1 text-white">Hora Saída</label>
    ...
    <div>
        <label class="block font-semibold mb-1 text-white">Nome</label>
    ...
    <div>
        <label class="block font-semibold mb-1 text-white">Morada</label>
    ...
    <div>
        <label class="block font-semibold mb-1 text-white">Agregado Familiar</label>
    ...
    <div class="md:col-span-2">
        <label class="block font-semibold mb-1 text-white">Informações Extra</label>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        <label class="block font-semibold mb-1 text-white">Instruções</label>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div class="md:col-span-2">
        <label class="block font-semibold mb-1 text-white">Timeline</label>

...
<div class="container mx-auto px-4 max-w-lg font-mono">
    <div class="bg-slate-700 rounded-xl shadow-xl p-8 mt-8">
        <h2 class="text-2xl font-semibold text-white mb-6 text-center uppercase">Registar Nova Avaria</h2>
        <form method="POST" action="{{ route('avarias.store') }}">
            @csrf

            <div class="mb-4">
                <label for="cod_categoria" class="block text-white font-semibold mb-2 uppercase">Tipo de Material</label>
            ...
            <div class="mb-4">
                <label for="cod_marca" class="block text-white font-semibold mb-2 uppercase">Marca</label>
            ...
            <div class="mb-4">
                <label for="cod_modelo" class="block text-white font-semibold mb-2 uppercase">Modelo</label>
            ...
            <div class="mb-4">
                <label for="num_serie" class="block text-white font-semibold mb-2 uppercase">Número de Série</label>
            ...
            <div class="mb-4">
                <label for="data_registo" class="block text-white font-semibold mb-2 uppercase">Data de Registo</label>
            ...
            <div class="mb-4">
                <label for="cod_material" class="block text-white font-semibold mb-2 uppercase">Código do Material Selecionado</label>

            ...
            <div class="mb-4">
                ...
                <select name="cod_servico" id="cod_servico" class="form-select w-full rounded border-gray-300 text-black">
                    ...
                    @foreach($servicos as $servico)
                        <option value="{{ $servico->cod_servico }}" {{ $perda->cod_servico == $servico->cod_servico ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <select name="cod_estado" id="cod_estado" class="form-select w-full rounded border-gray-300 text-black" required>
                    ...
                    @foreach($estados as $estado)
                        <option value="{{ $estado->cod_estado }}" {{ $perda->material && $perda->material->cod_estado == $estado->cod_estado ? 'selected' : '' }}>
                            {{ $estado->estado_nome }}
                        </option>
                    @endforeach
                </select>
